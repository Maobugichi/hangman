...
export default function RuleBox({num, title, text}) {
    return(
        <div className="bg-white lg:w-[32%] w-full h-auto min-h-[200px] lg:min-h-[400px] lg:rounded-[9%] rounded-[4%]  p-7 grid items-center">
          <div className=" lg:h-[320px] h-[85%] w-[95%]  flex flex-col  lg:items-center justify-between ">
