...
export default function RuleBox({num, title, text}) {
    return(
        <div className="bg-white lg:w-[32%] w-full h-auto min-h-[200px] lg:min-h-[400px] lg:rounded-[9%] rounded-[4%]  p-7 grid items-center gap-4">
          <div className=" lg:h-[320px] h-full bg-blue-700 w-[95%]  flex flex-col  lg:items-center lg:justify-between ">
            ...
            <p className="lg:text-[20px] w-[90%] lg:tracking-wider lg:text-center lg:text-[#887dc0] text-black leading-tight">{text}</p>
          </div>
        </div>
    )
}